...
## 📑 Table of Contents
- [Zaalima Multi-Tenant E-Commerce Platform](#zaalima-multi-tenant-e-commerce-platform)
  ...
  - [🔄 Key Core Workflows \& Lifecycles](#-key-core-workflows--lifecycles)
  ...
  - [🔌 Comprehensive REST API Reference](#-comprehensive-rest-api-reference)
    ...
    - [🏪 Store Management (`/api/stores`)](#-store-management-apistores)
    - [📦 Products \& Categories (`/api/products`, `/api/categories`)](#-products--categories-apiproducts-apicategories)
    - [🛒 Orders \& Fulfillment (`/api/orders`)](#-orders--fulfillment-apiorders)
    - [🎟️ Coupons (`/api/coupons`)](#️-coupons-apicoupons)
    - [💳 Payments (`/api/payments`)](#-payments-apipayments)
    - [🛡️ Super Admin Suite (`/api/admin`)](#️-super-admin-suite-apiadmin)
  - [🚀 Getting Started \& Local Setup](#-getting-started--local-setup)
    - [Prerequisites](#prerequisites)
    - [Environment Configuration](#environment-configuration)
      - [1. Backend (`backend/.env`)](#1-backend-backendenv)
      - [2. Customer Marketplace (`customer-side-frontend/.env`)](#2-customer-marketplace-customer-side-frontendenv)
    - [Super Admin Seeding](#super-admin-seeding)
    - [Running the Services](#running-the-services)
  - [🧭 Platform Access \& Role Matrix](#-platform-access--role-matrix)
  - [🛡️ Security \& Protection Mechanisms](#️-security--protection-mechanisms)
  - [📜 License](#-license)
